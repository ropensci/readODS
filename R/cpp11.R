...
write_sheet_ <- function(filename, x_list, column_types, sheet, cmax, row_names, col_names, rownames_x, colnames_x, na_as_string, padding, header, footer) {
  .Call(`_readODS_write_sheet_`, filename, x_list, column_types, sheet, cmax, row_names, col_names, rownames_x, colnames_x, na_as_string, padding, header, footer)
}
