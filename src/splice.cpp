...
[[cpp11::register]] std::string splice_sheet_(const std::string original_xml,
  ...
  if (!flat) {
    root_node = spreadsheet1.first_node()
                    ->first_node("office:body")
                    ->first_node("office:spreadsheet");
  } else {
    root_node = spreadsheet1.first_node("office:document")
                    ->first_node("office:body")
                    ->first_node("office:spreadsheet");
  }
...
[[cpp11::register]] std::string update_sheet_(const std::string original_xml,
                                              const std::string sheet_file,
                                              const bool flat,
  ...
  if (!flat) {
    root_node = spreadsheet1.first_node()
                    ->first_node("office:body")
                    ->first_node("office:spreadsheet")
                    ->first_node("table:table");
    parent_node = spreadsheet1.first_node()
                      ->first_node("office:body")
                      ->first_node("office:spreadsheet");
    ...
    root_node = spreadsheet1.first_node("office:document")
                    ...
                    ->first_node("office:spreadsheet")
                    ->first_node("table:table");
    parent_node = spreadsheet1.first_node("office:document")
                      ->first_node("office:body")
                      ->first_node("office:spreadsheet");
  }
