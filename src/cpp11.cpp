...
extern "C" SEXP _readODS_ods_get_sheet_names_(SEXP file, SEXP include_external_data) {
  BEGIN_CPP11
    return cpp11::as_sexp(ods_get_sheet_names_(cpp11::as_cpp<cpp11::decay_t<const std::string>>(file), cpp11::as_cpp<cpp11::decay_t<const bool>>(include_external_data)));
  END_CPP11
}
// read_ods_.cpp
...
static const R_CallMethodDef CallEntries[] = {
    {"_readODS_ods_get_sheet_names_", (DL_FUNC) &_readODS_ods_get_sheet_names_, 2},
