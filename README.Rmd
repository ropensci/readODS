...
Also, this package can't handle ODS files larger than "medium size". See [issue #71](https://github.com/ropensci/readODS/issues/71). If you need to read large ODS files efficiently, the [headless interface of LibreOffice](https://help.libreoffice.org/Common/Starting_the_Software_With_Parameters) is recommended to convert your ODS to CSV.
